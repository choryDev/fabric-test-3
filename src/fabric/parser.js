...
(function () {
  ...
  fabric.parseSVGDocument = function (doc, callback, reviver, parsingOptions) {
    ...
    descendants
      .filter(function (el) {
        var name = el.nodeName.replace("svg:", "");
        return (
          name === "clipPath" ||
          (name === "mask" && el.id.startsWith("CLIPPATH_"))
        );
      })
      .forEach(function (el) {
    ...
    //console.log(descendants, elements, clipPaths);
  ...
  extend(fabric, {
    ...
    parseAttributes: function (element, attributes, svgUid) {
      ...
      for (var attr in ownAttributes) {
        ...
        //attr === "mask" && console.log(attr, normalizedAttr, normalizedValue);
